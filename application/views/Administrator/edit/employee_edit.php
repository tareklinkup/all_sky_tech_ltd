                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select class="chosen-select form-control" name="status" id="status" data-placeholder="Choose a status...">
                            ...
                            <option value="d" <?php if ($selected->status == 'd') { ?> selected="selected" <?php } ?>> Deactive </option>
                        </select>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="form-horizontal">
            ...
            <div class="col-sm-6">
                ...
                <hr />
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="em_commission"> Employee Commission % </label>
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-5">
                        <input type="number" id="em_commission" min="0.00" step="0.01" name="em_commission" placeholder="Commision %" class="form-control" />
                    </div>
                    <div class="col-sm-1 no-padding-left">
                        <label style="background: #e7e7e7;width: 100%;text-align: center;height: 24px;" for="">%</label>
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-4 control-label" for="em_Education_Details"> Education Details </label>
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
