...
class Supplier extends CI_Controller
{
    ...
    function supplier_payment_history()
    {
        $access = $this->mt->userAccess();
        if (!$access) {
            redirect(base_url());
    ...
    public function getSupplierLedger()
    {
        ...
        select 
            'c' as sequence,
            sp2.SPayment_invoice as reference,
        ...
        select
            'd' as sequence,
            pr.PurchaseMaster_InvoiceNo as reference,
    ...
    public function getSupplierPayments()
    {
        ...
        $payments = $this->db->query("
            ...
            and sp.SPayment_brunchid = ? $paymentTypeClause $clauses $dateClause
