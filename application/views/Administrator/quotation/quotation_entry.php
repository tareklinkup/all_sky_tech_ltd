...
<div id="quotation" class="row">
    <div class="col-sm-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-8">
                                    <v-select v-bind:options="customers" v-model="selectedCustomer" label="display_name" v-on:input="customerOnChange"></v-select>
                                </div>
                            </div>
                            <div class="form-group clearfix">
                                <label class="col-sm-4 control-label no-padding-right"> Customer</label>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right">
                                        Product </label>
                                    <div class="col-sm-8">
                                        <v-select id="productm" ref="productm" v-bind:options="products" v-model="selectedProduct" label="display_text" v-on:input="productOnChange">
                                        </v-select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" step="0.01" placeholder="Qty" class="form-control" ref="quantity" v-model="selectedProduct.quantity" v-on:input="productTotal" autocomplete="off" min="1" required />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right"> Disc. % </label>
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-sm-5">
                                        ...
                                        <!-- <input type="text" id="quantity" placeholder="discount" class="form-control"
                                            v-model="selectedProduct.discount" v-on:input="productTotal"
                                ...
                                <!-- <div class="form-group" style="display:none;">
                                    ...
                                    <div class="col-sm-9">
                                        <span>(%)</span>
                                        <input type="text" step="0.01" placeholder="Discount" class="form-control" style="display: inline-block; width: 90%" />
                                    </div>
                                </div> -->
                                <div class="form-group">
                ...
                <table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
                    <thead>
                        <tr class="">
                            ...
                            <th style="width:25%;color:#000;">G/W</th>
                            ...
                            <div class="table-responsive">
                                <table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label class="col-sm-12 col-sm-12 col-md-12 col-lg-12 control-label no-padding-right">
                                                    Vat </label>
                                                <div class="col-sm-4">
        ...
        methods: {
            ...
            addToCart() {
                ...
                let product = {
                    ...
                    Guarantee: this.selectedProduct.Guarantee,
                ...
                this.calculateTotal();
                // this.clearProduct();
                document.querySelector('#productm input[role="combobox"]').focus();
            ...
            saveQuotation() {
                ...
                this.quotation.customer_id = this.selectedCustomer.Customer_SlNo
