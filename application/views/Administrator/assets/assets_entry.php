					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="asset_id"> Asset Id </label>
								<label class="col-sm-1 control-label no-padding-right">:</label>
								<div class="col-sm-7">
									<input type="text" name="asset_id" class="form-control" value="<?= $assetserial ?>" readonly />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label no-padding-right">:</label>
								<div class="col-sm-7">
									<input type="text" id="serial" required name="serial" placeholder="Serials" class="form-control" />
									<span id="error"></span>
								</div>
							</div>
