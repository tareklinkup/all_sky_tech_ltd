        ...
        <div class="form-horizontal">
                    ...
                    <div class="col-sm-6">
                        <select class="chosen-select form-control" name="employee" id="employee" data-placeholder="Choose a Employee..." required>
                            ...
                            foreach ($employees as $employee) { ?>
                                <option value="<?= $employee->Employee_SlNo; ?>" <?= ($selected->Employee_id == $employee->Employee_SlNo) ? 'selected' : '' ?>><?= $employee->Employee_ID . ' - ' . $employee->Employee_Name  ?></option>
                            <?php } ?>
                        </select>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="text" id="username" name="username" onchange="check_username()" value="<?php echo $selected->User_Name; ?>" class="form-control" />
...
<script type="text/javascript">
    function Updatesubmit() {
        ...
        var inputdata = 'id=' + id + '&username=' + username + '&user_email=' + user_email + '&rePassword=' + rePassword + '&txtFirstName=' + txtFirstName + '&Brunch=' + Brunch + '&type=' + type + '&oldpassword=' + oldpassword + '&employee=' + Emp;
