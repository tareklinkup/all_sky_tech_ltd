            ...
            <div class="col-md-4">
                <div class="account-section">
                    ...
                    <div class="col2">
                        ...
                        <h3 style="display:none;" v-bind:style="{display: totalCashIn > 0 ? '' : 'none'}">tk.
                            {{ totalCashIn | decimal }}</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="account-section">
                    ...
                    <div class="col2">
                        ...
                        <h3 style="display:none;" v-bind:style="{display: totalCashOut > 0 ? '' : 'none'}">tk.
                            {{ totalCashOut | decimal }}</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="account-section">
                    ...
                    <div class="col2">
                        ...
                        <h3 style="display:none;" v-bind:style="{display: cashBalance == 0 ? 'none' : ''}">tk.
                            {{ cashBalance | decimal }}</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                        ...
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: sales.length > 0 ? '' : 'none'}">{{ totalSales | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                ...
                <table class="table table-bordered table-condensed">
                    ...
                    <tbody style="display:none;"
                        v-bind:style="{display: receivedFromCustomers.length > 0 ? '' : 'none'}">
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: receivedFromCustomers.length > 0 ? '' : 'none'}">{{ totalReceivedFromCustomers | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                ...
                <table class="table table-bordered table-condensed">
                    ...
                    <tbody style="display:none;"
                        v-bind:style="{display: receivedFromSuppliers.length > 0 ? '' : 'none'}">
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: receivedFromSuppliers.length > 0 ? '' : 'none'}">{{ totalReceivedFromSuppliers | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: cashReceived.length > 0 ? '' : 'none'}">{{ totalCashReceived | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: bankWithdraws.length > 0 ? '' : 'none'}">{{ totalBankWithdraw | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: investReceives.length > 0 ? '' : 'none'}">{{ totalInvestReceived | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: loanReceives.length > 0 ? '' : 'none'}">{{ totalLoanReceived | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: purchases.length > 0 ? '' : 'none'}">{{ totalPurchase | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: paidToSuppliers.length > 0 ? '' : 'none'}">{{ totalPaidToSuppliers | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: paidToCustomers.length > 0 ? '' : 'none'}">{{ totalPaidToCustomers | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: cashPaid.length > 0 ? '' : 'none'}">{{ totalCashPaid | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: bankDeposits.length > 0 ? '' : 'none'}">{{ totalBankDeposit | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: employeePayments.length > 0 ? '' : 'none'}">{{ totalEmployeePayments | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: investPayments.length > 0 ? '' : 'none'}">{{ totalInvestPayment | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: loanPayments.length > 0 ? '' : 'none'}">{{ totalLoanPayment | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
