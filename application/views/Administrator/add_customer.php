		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<textarea cols="30" rows="2" class="form-control" v-model="customer.Customer_Address"></textarea>
			...
			<div class="col-md-5">
				...
				<!-- <div class="form-group clearfix">
					...
					<div class="col-md-1" style="padding:0;margin-left: -15px;"><a href="/add-referance" target="_blank" class="add-button"><i class="fa fa-plus"></i></a></div>
			</div> -->
	...
	new Vue({
		...
		methods: {
			...
			saveCustomer() {
				...
				// if (this.selectedReferance.referance_id == '') {
				// 	alert('Select Referance Name');
				// 	return;
				// } else {
				// 	this.customer.Referance_No = this.selectedReferance.referance_id
				// }
			...
			editCustomer(customer) {
				...
				// this.selectedReferance = {
				// 	referance_id: customer.referance_id,
				// 	referance_name: customer.referance_name
				// }
			},
