...
<span id="Edit_emloyee_form">
        ...
        <div class="form-horizontal">
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="Employeer_id" id="Employeer_id" name="Employeer_id" value="<?php echo $generateCode; ?>" class="form-control" readonly />
                    </div>
                </div>
    ...
    <div class="row">
        <div class="form-horizontal">
            ...
            <div class="col-sm-6">
                <div class="col-sm-12 align-center"> <strong>Additional Information</strong></div>

                <hr />
                <div class="form-group commission">
                    <label class="col-sm-3 control-label" for="em_commission"> Commission % </label>
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-7" id="addNew">
                        <div class="row">
                            <div class="col-sm-4 no-padding-right">
                                <input type="number" name="em_commission" placeholder="Start" class="form-control" />
                            </div>
                            <div class="col-sm-4 no-padding-right">
                                <input type="number" name="em_commission" placeholder="End" class="form-control" />
                            </div>
                            <div class="col-sm-4">
                                <input type="number" id="em_commission" min="0.00" step="0.01" name="em_commission" placeholder="%" class="form-control" />
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-1" style="padding: 0;">
                        <a href="" id="addrows" title="Add" class="btn btn-xs btn-danger" style="height: 224x; border: 0; width: 24px; margin-left: -10px;">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="em_Education_Details"> Education Details </label>
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-7">
                        <textarea id="em_Education_Details" name="em_Education_Details" placeholder="Education Details" class="form-control" cols="30" rows="6"></textarea>
                    </div>
                </div>
...
<script type="text/javascript">
    function Employee_submit() {
        ...
        var em_commission = $("#em_commission").val();
        var em_Education_Details = $("#em_Education_Details").val();
        ...
        fd.append('em_commission', $('#em_commission').val());
        fd.append('em_Education_Details', $('#em_Education_Details').val());
