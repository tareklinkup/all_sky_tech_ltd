...
<div id="customerPayment">
                ...
                <div class="row">
                    <div class="col-md-5 col-md-offset-1">
                        ...
                        <div class="form-group" style="display:none;"
                            v-bind:style="{display: payment.CPayment_Paymentby == 'bank' ? '' : 'none'}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <v-select v-bind:options="customers" v-model="selectedCustomer" label="display_name"
                                    @input="getCustomerDue" v-if="customers.length > 0"></v-select>
                            </div>
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <label class="col-md-1">:</label>
                            <div class="col-md-7">
                                <input type="date" class="form-control" v-model="payment.CPayment_date" required
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-right">
            <button class="btn btn-sm btn-success" onclick="exportTableToCSV('customer-payments.csv')">Export To
                CSV</button>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="button edit"
                                    @click="window.location = `/paymentAndReport/${row.CPayment_id}`">
