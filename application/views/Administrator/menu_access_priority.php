...
<div id="userAccess">
    ...
    <div class="row" style="margin-bottom: 15px;">
        <div class="col-md-12">
            <input type="checkbox" @click="checkAll" id="selectAll"> <strong style="font-size: 16px;">Select
                All</strong>
        </div>
    </div>
    <div class="row" id="accessRow">
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="sales">
                    ...
                    <li><input type="checkbox" class="access" value="services" v-model="access"> Service Entry</li>
                    ...
                    <li><input type="checkbox" class="access" value="servicesinvoice" v-model="access"> Service Invoice
                    </li>
                    <li><input type="checkbox" class="access" value="s_record" v-model="access"> Service Record</li>
                    <li><input type="checkbox" class="access" value="currentStock" v-model="access"> Stock</li>
                    <!-- <li><input type="checkbox" class="access" value="productLedger" v-model="access"> product Ledger
                    </li> -->
                    <li><input type="checkbox" class="access" value="serial_history" v-model="access"> Serial History</li>
                    <li><input type="checkbox" class="access" value="quotation" v-model="access"> Quotation Entry</li>
                </ul>
            </div>

            <div class="group">
                <input type="checkbox" id="accounts" class="group-head" @click="onClickGroupHeads">
                <strong>Accounts</strong>
                <ul ref="accounts">
                    <li><input type="checkbox" class="access" value="cashTransaction" v-model="access"> Cash
                        Transactions</li>
                    <li><input type="checkbox" class="access" value="bank_transactions" v-model="access"> Bank
                        Transactions</li>
                    <li><input type="checkbox" class="access" value="customerPaymentPage" v-model="access"> Customer
                        Payment</li>
                    <li><input type="checkbox" class="access" value="supplierPayment" v-model="access"> Supplier Payment
                    </li>
                    <li><input type="checkbox" class="access" value="loan_transactions" v-model="access"> Loan
                        Transaction
                    </li>
                    <li><input type="checkbox" class="access" value="loan_view" v-model="access"> Loan View
                    </li>
                    <li><input type="checkbox" class="access" value="loan_transaction_report" v-model="access"> loan
                        Transaction Report
                    </li>
                    <li><input type="checkbox" class="access" value="loan_ledger" v-model="access"> loan
                        Ledger
                    </li>
                    <li><input type="checkbox" class="access" value="loan_accounts" v-model="access"> loan Accounts
                    </li>

                    <li><input type="checkbox" class="access" value="investment_transactions" v-model="access">
                        Investment Transactions
                    </li>

                    <li><input type="checkbox" class="access" value="investment_view" v-model="access"> investment_view
                    </li>

                    <li><input type="checkbox" class="access" value="investment_transaction_report" v-model="access">
                        investment Transaction Report
                    </li>

                    <li><input type="checkbox" class="access" value="investment_ledger" v-model="access"> Investment
                        Ledger
                    </li>

                    <li><input type="checkbox" class="access" value="investment_account" v-model="access"> Investment
                        Account
                    </li>


                    <li><input type="checkbox" class="access" value="cash_view" v-model="access"> Cash View</li>
                    <li><input type="checkbox" class="access" value="account" v-model="access"> Transaction Accounts
                    </li>
                    <li><input type="checkbox" class="access" value="bank_accounts" v-model="access"> Bank Accounts</li>
                    <li><input type="checkbox" class="access" value="check/entry" v-model="access"> New Cheque Entry
                    </li>
                    <li><input type="checkbox" class="access" value="check/list" v-model="access"> Cheque List</li>
                    <li><input type="checkbox" class="access" value="check/reminder/list" v-model="access"> Reminder
                        Cheque List</li>
                    <li><input type="checkbox" class="access" value="check/pending/list" v-model="access"> Pending
                        Cheque List</li>
                    <li><input type="checkbox" class="access" value="check/dis/list" v-model="access"> Dishonered Cheque
                        List</li>
                    <li><input type="checkbox" class="access" value="check/paid/list" v-model="access"> Paid Cheque List
                    </li>
                </ul>
            </div>
        </div>
        <div class="col-md-3">
            <div class="group">
                <input type="checkbox" id="salesReports" class="group-head" @click="onClickGroupHeads"> <strong>Sales
                    Reports</strong>
                <ul ref="salesReports">
                    <li><input type="checkbox" class="access" value="salesinvoice" v-model="access"> Sales Invoice</li>
                    <li><input type="checkbox" class="access" value="returnList" v-model="access"> Sales Return List
                    </li>
                    <li><input type="checkbox" class="access" value="customerDue" v-model="access"> Customer Due List
                    </li>
                    <li><input type="checkbox" class="access" value="customerPaymentReport" v-model="access"> Customer
                        Payment Report</li>
                    <li><input type="checkbox" class="access" value="customer_payment_history" v-model="access">
                        Customer Payment History</li>
                    <li><input type="checkbox" class="access" value="customerlist" v-model="access"> Customer List</li>
                    <li><input type="checkbox" class="access" value="price_list" v-model="access"> Product Price List
                    </li>
                    <li><input type="checkbox" class="access" value="quotation_invoice_report" v-model="access">
                        Quotation Invoice</li>
                    <li><input type="checkbox" class="access" value="quotation_record" v-model="access"> Quotation
                        Record</li>
                </ul>
            </div>

            <div class="group">
                <input type="checkbox" id="accountsReports" class="group-head" @click="onClickGroupHeads">
                <strong>Accounts Reports</strong>
                <ul ref="accountsReports">
                    <li><input type="checkbox" class="access" value="TransactionReport" v-model="access"> Cash
                        Transaction Report</li>
                    <li><input type="checkbox" class="access" value="bank_transaction_report" v-model="access"> Bank
                        Transaction Report</li>
                    ...
                    <li><input type="checkbox" class="access" value="profitLoss" v-model="access"> Profit/Loss Report
                    </li>
        ...
        <div class="col-md-3">
            <div class="group">
                <input type="checkbox" id="purchase" class="group-head" @click="onClickGroupHeads">
                <strong>Purchase</strong>
                <ul ref="purchase">
                    <li><input type="checkbox" class="access" value="purchase" v-model="access"> Purchase Entry</li>
                    <li><input type="checkbox" class="access" value="purchaseReturns" v-model="access"> Purchase Return
                    </li>
                    <li><input type="checkbox" class="access" value="purchaseRecord" v-model="access"> Purchase Record
                    </li>
        ...
        <div class="col-md-3">
            <div class="group">
                <input type="checkbox" id="purchaseReports" class="group-head" @click="onClickGroupHeads">
                <strong>Purchase Reports</strong>
                <ul ref="purchaseReports">
                    <li><input type="checkbox" class="access" value="purchaseInvoice" v-model="access"> Purchase Invoice
                    </li>
                    <li><input type="checkbox" class="access" value="supplierDue" v-model="access"> Supplier Due</li>
                    <li><input type="checkbox" class="access" value="supplierPaymentReport" v-model="access"> Supplier
                        Payment Report</li>
                    <li><input type="checkbox" class="access" value="supplierPaymentHistory" v-model="access"> Supplier
                        Payment History</li>
                    <li><input type="checkbox" class="access" value="supplierList" v-model="access"> Supplier List</li>
                    <li><input type="checkbox" class="access" value="returnsList" v-model="access"> Purchase Return List
                    </li>
                    <li><input type="checkbox" class="access" value="reorder_list" v-model="access"> Re-Order List</li>
                </ul>
            </div>
            <div class="group">
                <input type="checkbox" id="admin" class="group-head" @click="onClickGroupHeads">
                ...
                <ul ref="admin">
                    ...
                    <li><input type="checkbox" class="access" value="product_ledger" v-model="access"> product Ledger
                    </li>
                    ...
                    <li><input type="checkbox" class="access" value="product_transfer" v-model="access"> Product
                        Transfer</li>
                    ...
                    <li><input type="checkbox" class="access" value="add-referance" v-model="access"> Add Referance</li>
                    <li><input type="checkbox" class="access" value="companyProfile" v-model="access"> Company Profile
                    </li>
                    <li><input type="checkbox" class="access" value="database_backup" v-model="access"> Database Backup
                    </li>
