        ...
        <div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
            <div class="col-md-5 col-md-offset-1">
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <v-select v-bind:options="employees" label="display_name" v-model="selectedEmployee" @input="getPayableCommission"></v-select>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <v-select v-bind:options="months" label="month_name" v-model="selectedMonth" @input="getPayableCommission"></v-select>
                    </div>
                ...
                <div class="form-group">
                    <label class="control-label col-md-4">Payable Commission</label>
                    <div class="col-md-7">
            ...
            <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input type="number" min="0" class="form-control" v-model="payment.payment_amount">
                    </div>
                </div>
    ...
    new Vue({
        ...
        methods: {
            ...
            getPayableCommission() {
                ...
                axios.post('/get_payable_commission', data).then(res => {
                    let response = res.data[0]
                    this.payable_amount = (((parseFloat(response.sale_total) * parseFloat(response.com_percent)) / 100) - parseFloat(response.payment)).toFixed(2)
                    // this.payable_amount = res.data.;
                })
            },
            getPayments() {
                axios.get('/get_employee_payments').then(res => {
                    this.payments = res.data.filter(obj => obj.payment_for == 'commission');
                })
            },
            savePayment() {
