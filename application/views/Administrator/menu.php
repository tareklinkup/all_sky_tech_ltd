...
<?php } elseif ($module == 'Administration') { ?>
    <ul class="nav nav-list">
        ...
        <?php if (
            ...
            || array_search("add-referance", $access) > -1
            || isset($CheckSuperAdmin) || isset($CheckAdmin)
        ) : ?>
            <li class="">
                <a href="<?php echo base_url(); ?>" class="dropdown-toggle">
                ...
                <ul class="submenu">
                    ...
                    <?php if (array_search("add-referance", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
                        <li class="">
                            <a href="<?php echo base_url(); ?>add-referance">
                                <i class="menu-icon fa fa-caret-right"></i>
                                <span class="menu-text"> Add Referance </span>
                            </a>
                            <b class="arrow"></b>
                        </li>
                    <?php endif; ?>
...
<?php } elseif ($module == 'SalesModule') { ?>
    <ul class="nav nav-list">
        ...
        <?php if (array_search("services", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <li class="">
        ...
        <?php if (array_search("/returnIemi", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <li class="">
                <a href="<?php echo base_url(); ?>returnIemi">
                    <i class="menu-icon fa fa-usd"></i>
                    <span class="menu-text"> Serial sale Return </span>
                </a>
                <b class="arrow"></b>
            </li>
        <?php endif; ?> -->
            ...
            <?php if (
                ...
                || array_search("servicesinvoice", $access) > -1
                || array_search("s_record", $access) > -1
                ...
                <li class="">
                    ...
                    <ul class="submenu">
                        ...
                        <?php endif; ?>
                        <?php if (array_search("s_record", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
                            <li class="">
...
<?php } elseif ($module == 'PurchaseModule') { ?>
    <ul class="nav nav-list">
        ...
        <!-- <?php if (array_search("purchaseReturnsImei", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <li class="">
                <a href="<?php echo base_url(); ?>purchaseReturnsImei">
                    <i class="menu-icon fa fa-rotate-right"></i>
                    <span class="menu-text"> Serial Purc. Return </span>
                </a>
                <b class="arrow"></b>
            </li>
        <?php endif; ?> -->
        ...
        <?php if (
            ...
            || array_search("supplierPaymentHistory", $access) > -1
            ...
            <li class="">
                ...
                <ul class="submenu">
                    ...
                    <?php if (array_search("supplierPaymentHistory", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
                        <li class="">
                            <a href="<?php echo base_url(); ?>supplierPaymentHistory">
                                <i class="menu-icon fa fa-caret-right"></i>
...
<?php } elseif ($module == 'HRPayroll') { ?>
    <ul class="nav nav-list">
        ...
        <?php if (array_search("commission_payment", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <li class="">
                <a href="<?php echo base_url(); ?>commission_payment">
                    <i class="menu-icon fa fa-usd"></i>
        ...
        <?php if (
            ...
            <li class="">
                ...
                <ul class="submenu">
                    ...
                    <?php endif; ?>
                    <?php if (array_search("emp_commission_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
                        <li class="">
                            <a href="<?php echo base_url(); ?>emp_commission_report">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Commision Report
                            </a>
                            <b class="arrow"></b>
