    ...
    <form @submit.prevent="saveProduct">
        <div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
            <div class="col-md-5">
                ...
                <div class="form-group clearfix">
                    <label class="control-label col-md-4">Specification:</label>
                    <div class="col-md-7">
                        <v-select v-bind:options="varients" v-model="selectedVarient" label="varient_name"></v-select>
                    </div>
                    <div class="col-md-1" style="padding:0;margin-left: -15px;"><a href="/varient" target="_blank" class="add-button"><i class="fa fa-plus"></i></a></div>
                </div>
                <div class="form-group clearfix">
                ...
                <!-- <div class="form-group clearfix">
					<label class="control-label col-md-4">Cartoon Size:</label>
					<div class="col-md-7">
						<input type="text" class="form-control" v-model="product.box" required>
					</div>
				</div> -->
                <!-- <div class="form-group clearfix">
					<label class="control-label col-md-4">Shelf No.:</label>
					<div class="col-md-7">
						<input type="text" class="form-control" v-model="product.shelf" required>
					</div>
				</div> -->
                <div class="form-group clearfix">
            ...
            <div class="col-md-5">
                <div class="form-group clearfix">
                    <label class="control-label col-md-4">Guarantee:</label>
                    <div class="col-md-7">
                        <div class="row">
                            <div class="col-md-5">
                                <input type="number" class="form-control" v-model="product.Guarantee" placeholder="days">
                            </div>

                            <label class="control-label col-md-2 no-padding">Warranty:</label>
                            <div class="col-md-5">
                                <input type="number" class="form-control" v-model="product.Warranty" placeholder="days">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- <div class="form-group clearfix">
					<label class="control-label col-md-4">Minimum Sale Rate:</label>
					<div class="col-md-7">
						<input type="text" class="form-control" v-model="product.Product_MinimumSellingPrice" required>
					</div>
				</div> -->
                ...
                <div class="form-group clearfix">
                    <label class="control-label col-md-4">Serial Product:</label>
                    <div class="col-md-7">
                        <input type="radio" id="serial" v-model="product.Is_Serial" value="true">
                        <label for="serial">Serial</label>
                        <input style="margin-left: 20px;" id="non-serial" type="radio" v-model="product.Is_Serial" value="false">
                    ...
                    <template scope="{ row }">
                        <tr>
                            ...
                            <td>
                                ...
                                <?php } ?>
                                <button v-if="row.Is_Serial == 'true'" type="button" class="button" @click="window.location = `/Administrator/products/barcodeGenerate/${row.Product_SlNo}`">
...
<script>
    ...
    new Vue({
        ...
        methods: {
            ...
            getVarients() {
                axios.get('/get_varients').then(res => {
            ...
            saveProduct() {
                ...
                if (this.product.Is_Serial == '') {
                    alert('Select Serial or NonSerial');
                    return;
                }
                ...
                this.product.varient = this.selectedVarient.id;
